...
class HotelMapViewController: UIViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let image = UIImage(named: "floorplan.png")!
        ...
        let doubleTapRecognizer = UITapGestureRecognizer(target: self, action: #selector(HotelMapViewController.scrollViewDoubleTapped(_:)))
